  ...
  return (
    <HashRouter>
      <Routes>
        ...
        <Route exact path="/aulas/html/cap1/aula1" element={<Hc1a1 />} />
        <Route exact path="/aulas/html/cap1/aula2" element={<Hc1a2 />} />
        <Route exact path="/aulas/html/cap1/aula3" element={<Hc1a3 />} />
        <Route exact path="/aulas/html/cap2/aula1" element={<Hc2a1 />} />
        <Route exact path="/aulas/html/cap2/aula2" element={<Hc2a2 />} />
        <Route exact path="/aulas/html/cap2/aula3" element={<Hc2a3 />} />
        <Route exact path="/aulas/html/cap3/aula1" element={<Hc3a1 />} />
        <Route exact path="/aulas/html/cap3/aula2" element={<Hc3a2 />} />
        <Route exact path="/aulas/html/cap3/aula3" element={<Hc3a3 />} />
        <Route exact path="/aulas/css/cap1/aula1" element={<Cc1a1 />} />
        <Route exact path="/aulas/css/cap1/aula2" element={<Cc1a2 />} />
        <Route exact path="/aulas/css/cap1/aula3" element={<Cc1a3 />} />
        <Route exact path="/aulas/css/cap2/aula1" element={<Cc2a1 />} />
        <Route exact path="/aulas/css/cap2/aula2" element={<Cc2a2 />} />
        <Route exact path="/aulas/css/cap2/aula3" element={<Cc2a3 />} />
        <Route exact path="/aulas/css/cap3/aula1" element={<Cc3a1 />} />
        <Route exact path="/aulas/css/cap3/aula2" element={<Cc3a2 />} />
        <Route exact path="/aulas/css/cap3/aula3" element={<Cc3a3 />} />
        <Route exact path="/aulas/js/cap1/aula1" element={<Jc1a1 />} />
        <Route exact path="/aulas/js/cap1/aula2" element={<Jc1a2 />} />
        <Route exact path="/aulas/js/cap1/aula3" element={<Jc1a3 />} />
        <Route exact path="/aulas/js/cap2/aula1" element={<Jc2a1 />} />
        <Route exact path="/aulas/js/cap2/aula2" element={<Jc2a2 />} />
        <Route exact path="/aulas/js/cap2/aula3" element={<Jc2a3 />} />
        <Route exact path="/aulas/js/cap3/aula1" element={<Jc3a1 />} />
        <Route exact path="/aulas/js/cap3/aula2" element={<Jc3a2 />} />
        <Route exact path="/aulas/js/cap3/aula3" element={<Jc3a3 />} />
        <Route exact path="/aulas/php/cap1/aula1" element={<Pc1a1 />} />
        <Route exact path="/aulas/php/cap1/aula2" element={<Pc1a2 />} />
        <Route exact path="/aulas/php/cap1/aula3" element={<Pc1a3 />} />
        <Route exact path="/aulas/php/cap2/aula1" element={<Pc2a1 />} />
        <Route exact path="/aulas/php/cap2/aula2" element={<Pc2a2 />} />
        <Route exact path="/aulas/php/cap2/aula3" element={<Pc2a3 />} />
        <Route exact path="/aulas/php/cap3/aula1" element={<Pc3a1 />} />
        <Route exact path="/aulas/php/cap3/aula2" element={<Pc3a2 />} />
        <Route exact path="/aulas/php/cap3/aula3" element={<Pc3a3 />} />
