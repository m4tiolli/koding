    ...
    <div className={`flex h-full w-full dark:bg-darkcinzaclaro`}>
      <main className={`w-full ml-56 mr-2 overflow-hidden`}>
        ...
        <div className="flex h-64 w-5/12 ml-10 mt-10 items-center justify-center gap-3">
          <form
            action=""
            className={`flex rounded-xl w-full items-center justify-center text-white text-xl p-2 dark:bg-darkpesquisa bg-[${Color(
              mode,
              "#811CD7"
            )}]`}
          >
          ...
          <div className="flex h-10 w-56 space-x-8 items-center justify-center">
            <button>
              <BsFilter
                className={`flex items-center justify-center text-4xl text-white rounded-md dark:bg-darkpesquisa bg-[${Color(
                  mode,
                  "#811CD7"
                )}]`}
              />
        ...
        <div className="flex flex-col justify-center ml-10 space-y-8">
          ...
          <div className="flex space-x-16 items-center">
            <Link to={"/aulas"}>
              <div
                className={`w-72 h-52 rounded-xl ${Color(
                  mode,
