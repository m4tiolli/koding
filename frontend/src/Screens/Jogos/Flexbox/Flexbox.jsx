...
function Flexbox(){
    return(
        ...
        {/* Jogo */}
            ...
            <section className="relative sec w-50vw h-screen overflow-hidden min-w-[380px] min-h-[380px]" style={{background: "#E79D67"}}>
                ...
                <div className="flex flex-col items-center flex-wrap absolute tras left-0 top-0">
                    ...
                    <div className="vr-container">
                        {/* vr verde */}
                        <div className="vr verde" style={{transform: 'scale(0.88)', rotate: '322deg'}}></div>
                    </div>
                    <div className="vr-container">
                        <div className="vr verde" style={{transform: 'scale(0.95)', rotate: '10deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr verde" style={{transform: 'scale(0.99)', rotate: '34deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr verde" style={{transform: 'scale(0.81)', rotate: '67deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr verde" style={{transform: 'scale(0.83)', rotate: '90deg'}}></div>
                    </div>

                    <div className="vr-container">
                        {/* vr vermelho */}
                        <div className="vr vermelho" style={{transform: 'scale(0.82)', rotate: '221deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr vermelho" style={{transform: 'scale(0.94)', rotate: '122deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr vermelho" style={{transform: 'scale(0.88)', rotate: '190deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr vermelho" style={{transform: 'scale(0.97)', rotate: '70deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr vermelho" style={{transform: 'scale(0.90)', rotate: '145deg'}}></div>
                    </div>

                    <div className="vr-container">
                        {/* vr amarelo */}
                        <div className="vr amarelo" style={{transform: 'scale(0.89)', rotate: '269deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr amarelo" style={{transform: 'scale(0.82)', rotate: '20deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr amarelo" style={{transform: 'scale(0.91)', rotate: '98deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr amarelo" style={{transform: 'scale(0.88)', rotate: '321deg'}}></div>
                    </div>

                    <div className="vr-container">
                        <div className="vr amarelo" style={{transform: 'scale(0.96)', rotate: '108deg'}}></div>
                    </div>
